...
@section('content')
    ...
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">@lang('general.pages')</h3>
        ...
        <div class="box-body">
            <div class="row">
                <div class="col-xs-12">
                    <a href="{{ route('pages.create') }}" class="btn btn-app"><i
                                class="fa fa-plus"></i> @lang('general.pages_add')</a>
                </div>
            </div>
            <hr>
            <div class="row">
                                        ...
                                        <div class="btn-group">
                                            <a href="#"
                                               ...
                                               title="View Page" target="_blank" class="btn btn-default btn-sm"><i
                                                        class='fa fa-eye'></i></a>
                                            <a href="{{ route('pages.edit',$dat->id) }}" data-toggle="tooltip"
                                               title="Edit Page" class="btn btn-default btn-sm"><i
                                                        class='fa fa-pencil'></i></a>
                                            <button type="submit" data-toggle="tooltip" title="Delete Page"
